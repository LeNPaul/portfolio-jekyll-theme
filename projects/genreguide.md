---
layout: post
title: 'The Genre Guide'
permalink: /GENREGUIDE/
---
...
<a href="#bar" name="bar" onclick="toggle_visibility('disclosure');">Full Disclosure</a>
...
<a href="#bar" name="bar" onclick="toggle_visibility('references');">Acknowledgements and References</a>
...
<br><br>
Furthermore, and just as important, I also did my homework on Metal artists, songs, and genres. For a full list of resources used in the guide, go <a href="../REFERENCES" target="_blank" rel="noopener"><span>here</span></a>.
</div>
